...
const RAW_EMAILS = [
  "mcheung@transperfect.com",
  "tianxiao.jia@transperfect.com",
  "ocleung@transperfect.com",
  "aezama@transperfect.com",
  "hahopkins@transperfect.com",
  "jamkim@transperfect.com",
  "heshamy@transperfect.com",
  "yulee@transperfect.com",
  "mmilikemu@transperfect.com",
  "cheng.shen@transperfect.com"
]
